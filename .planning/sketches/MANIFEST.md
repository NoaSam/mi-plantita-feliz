...
- **004 · reclassify-from-detail** — *probablemente innecesario*: la pantalla 3 de la variante D del sketch 003 ya cubre el patrón de re-clasificación desde detalle. Reevaluar al planificar Phase 02.1.
